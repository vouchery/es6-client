 ...
 * @module Vouchery/RewardSetDiscount
 * @version 2.0.0
 */
class RewardSetDiscount {
    /**
     * Constructs a new <code>RewardSetDiscount</code>.
     * @alias module:Vouchery/RewardSetDiscount
     * @param type {module:Vouchery/RewardSetDiscount.TypeEnum} 
     * @param discountType {module:Vouchery/RewardSetDiscount.DiscountTypeEnum} Discount type defines if a customer should receive a discount of 10% or $10 on their order. Gft Card type of reward works as a gift card: voucher can be used several times, discount value can be distributed to many transactions.
     ...
     * @param {module:Vouchery/RewardSetDiscount} obj Optional instance to populate.
     * @return {module:Vouchery/RewardSetDiscount} The populated <code>RewardSetDiscount</code> instance.
     */
...
/**
 * @member {module:Vouchery/RewardSetDiscount.TypeEnum} type
 */
RewardSetDiscount.prototype['type'] = undefined;
 ...
 * @member {module:Vouchery/RewardSetDiscount.DiscountTypeEnum} discount_type
 */
