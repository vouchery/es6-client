 ...
 * @module Vouchery/ErrorErrors
 * @version 2.0.0
 */
class ErrorErrors {
    /**
     * Constructs a new <code>ErrorErrors</code>.
     * @alias module:Vouchery/ErrorErrors
     */
    constructor() {
     ...
     * @param {module:Vouchery/ErrorErrors} obj Optional instance to populate.
     * @return {module:Vouchery/ErrorErrors} The populated <code>ErrorErrors</code> instance.
     */
 ...
 * @member {module:Vouchery/ErrorErrors.CodeEnum} code
 */
