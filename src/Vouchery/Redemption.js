 ...
 * @module Vouchery/Redemption
 * @version 2.0.0
 */
class Redemption {
    /**
     * Constructs a new <code>Redemption</code>.
     * @alias module:Vouchery/Redemption
     ...
     * @param {module:Vouchery/Redemption} obj Optional instance to populate.
     * @return {module:Vouchery/Redemption} The populated <code>Redemption</code> instance.
     */
...
/**
 * @member {module:Vouchery/Redemption.TypeEnum} type
 */
...
/**
 * @member {module:Vouchery/RedemptionVoucher} voucher
 */
 ...
 * @member {Array.<module:Vouchery/RedemptionProductItems>} product_items
 */
