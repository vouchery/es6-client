 ...
 * @module Vouchery/InlineObject2
 * @version 2.0.0
 */
class InlineObject2 {
    /**
     * Constructs a new <code>InlineObject2</code>.
     * @alias module:Vouchery/InlineObject2
     */
    constructor() {
     ...
     * @param {module:Vouchery/InlineObject2} obj Optional instance to populate.
     * @return {module:Vouchery/InlineObject2} The populated <code>InlineObject2</code> instance.
     */
