 ...
 * @module Vouchery/Campaign
 * @version 2.0.0
 */
class Campaign {
    /**
     * Constructs a new <code>Campaign</code>.
     * @alias module:Vouchery/Campaign
     * @param type {module:Vouchery/Campaign.TypeEnum} This field is required only when you create a campaign. Main Campaign is a wrapper for multipe Sub Campaings, grouped together. Main Campaign can have own budget and redemptions limit.
     ...
     * @param {module:Vouchery/Campaign} obj Optional instance to populate.
     * @return {module:Vouchery/Campaign} The populated <code>Campaign</code> instance.
     */
 ...
 * @member {module:Vouchery/Campaign.TypeEnum} type
 */
...
/**
 * @member {module:Vouchery/Campaign.StatusEnum} status
 */
 ...
 * @member {module:Vouchery/Campaign.TriggersOnEnum} triggers_on
 */
 ...
 * @member {module:Vouchery/Campaign.VoucherTypeEnum} voucher_type
 */
 ...
 * @member {module:Vouchery/Campaign.VoucherCodeTypeEnum} voucher_code_type
 */
