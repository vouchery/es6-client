 ...
 * @module Vouchery/InlineObject3
 * @version 2.0.0
 */
class InlineObject3 {
    /**
     * Constructs a new <code>InlineObject3</code>.
     * @alias module:Vouchery/InlineObject3
     */
    constructor() {
     ...
     * @param {module:Vouchery/InlineObject3} obj Optional instance to populate.
     * @return {module:Vouchery/InlineObject3} The populated <code>InlineObject3</code> instance.
     */
