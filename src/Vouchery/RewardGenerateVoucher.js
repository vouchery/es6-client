 ...
 * @module Vouchery/RewardGenerateVoucher
 * @version 2.0.0
 */
class RewardGenerateVoucher {
    /**
     * Constructs a new <code>RewardGenerateVoucher</code>.
     * @alias module:Vouchery/RewardGenerateVoucher
     * @param type {module:Vouchery/RewardGenerateVoucher.TypeEnum} 
     * @param prefix {String} A prefix in all generated vouchers. Needs to be unique within a project.
     * @param codeType {module:Vouchery/RewardGenerateVoucher.CodeTypeEnum} What characters should the code include. Possible choices are digits, letters, and mixed.
     ...
     * @param {module:Vouchery/RewardGenerateVoucher} obj Optional instance to populate.
     * @return {module:Vouchery/RewardGenerateVoucher} The populated <code>RewardGenerateVoucher</code> instance.
     */
...
/**
 * @member {module:Vouchery/RewardGenerateVoucher.TypeEnum} type
 */
RewardGenerateVoucher.prototype['type'] = undefined;
 ...
 * @member {module:Vouchery/RewardGenerateVoucher.CodeTypeEnum} code_type
 */
