 ...
 * @module Vouchery/Customer
 * @version 2.0.0
 */
class Customer {
    /**
     * Constructs a new <code>Customer</code>.
     * @alias module:Vouchery/Customer
     ...
     * @param {module:Vouchery/Customer} obj Optional instance to populate.
     * @return {module:Vouchery/Customer} The populated <code>Customer</code> instance.
     */
 ...
 * @member {Array.<module:Vouchery/CustomerCategories>} categories
 */
