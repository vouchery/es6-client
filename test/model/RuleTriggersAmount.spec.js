...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new VoucheryApiReference.RuleTriggersAmount();
    });
    ...
    describe('RuleTriggersAmount', function() {
        it('should create an instance of RuleTriggersAmount', function() {
            // uncomment below and update the code to test RuleTriggersAmount
            //var instane = new VoucheryApiReference.RuleTriggersAmount();
            //expect(instance).to.be.a(VoucheryApiReference.RuleTriggersAmount);
        });
