...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new VoucheryApiReference.TimeframeRule();
    });
    ...
    describe('TimeframeRule', function() {
        it('should create an instance of TimeframeRule', function() {
            // uncomment below and update the code to test TimeframeRule
            //var instane = new VoucheryApiReference.TimeframeRule();
            //expect(instance).to.be.a(VoucheryApiReference.TimeframeRule);
        });
