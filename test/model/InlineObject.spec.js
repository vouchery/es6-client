...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new VoucheryApiReference.InlineObject();
    });
    ...
    describe('InlineObject', function() {
        it('should create an instance of InlineObject', function() {
            ...
            //var instane = new VoucheryApiReference.InlineObject();
            //expect(instance).to.be.a(VoucheryApiReference.InlineObject);
        });
