...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new VoucheryApiReference.TimeOfOrderRule();
    });
    ...
    describe('TimeOfOrderRule', function() {
        it('should create an instance of TimeOfOrderRule', function() {
            // uncomment below and update the code to test TimeOfOrderRule
            //var instane = new VoucheryApiReference.TimeOfOrderRule();
            //expect(instance).to.be.a(VoucheryApiReference.TimeOfOrderRule);
        });
